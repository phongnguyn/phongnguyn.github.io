    ...
    <main className="pt-10 pb-6 flex items-center flex-col">
      <div className="text-center">
        ...
        <p className="text-1xl text-md leading-8 dark:text-white pt-8 max-w-xl">
          My name is Tan Loc, but I also go with John. I am an indie full-stack web developer and try to be good at it. here&apos;s a collection of some of my simple projects.
        </p>
      </div>
      <Portfolio />
